...
function sobre.load()
  container = Object:new {
    ...
    content = {
      kind = 'text',
      color = Black,
      label = 'SOBRE:\nO OBJETIVO DESTE JOGO PREVÊ O APRENDIZADO E MELHORIA NA ESCRITA DOS ALUNOS QUE O JOGAREM, ELE É DIRECIONADO A PESSOAS QUE, INDEPENDENTE DO NÍVEL ACADÊMICO, SAIBAM CONCEITOS BÁSICOS DA ESCRITA E LEITURA.\nFEITO POR: ARTHUR BALDOQUI BERGAMO, CLAUDINEY GUSTAVO RODRIGUES DOS SANTOS, MARCOS VINICIUS PASSOS, NATÁLIA MENDES GOES, THALES JANISCH SANTOS E TIAGO PANIZIO GOTTARDO.\nREQUISITOS MÍNIMOS:\n- PROCESSADOR: 1.6 GHZ\n- MEMÓRIA: 1GB RAM\n- ARMAZENAMENTO: 40 MB DE ESPAÇO LIVRE'
    }
  }
