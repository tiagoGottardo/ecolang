...
function Level3video.load()
  ...
  video = Video:new { content = { name = 'level3.ogv' } }
...
function Level3video.update(dt)
  --Game.timer:update()
...
function Level3video.mousemoved(x, y, dx, dy, istouch)
  cursor:update(x, y)
end

function Level3video.draw()
  container:draw()
  footer:draw()
  proximoFooter:draw()
...
function Level3video.keypressed(key) end
